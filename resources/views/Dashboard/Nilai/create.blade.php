                ...
                <div class="p-2">
                    <form method="POST" action="/nilai/insertNilai/">
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-8">
                                <div class="dropdown">
                                    <select name="kode_matkul" id="kode_matkul" class="btn border btn-block text-start form-control">
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-8">
                                <div class="dropdown">
                                    <select name="nama_matkul" id="nama_matkul" class="btn border btn-block text-start form-control">
                                        <!-- <option value="" selected>-- Pilih matkul --</option> -->
                                        <option value="" selected>-- Pilih Matkul --</option>
                                        @foreach($matkul as $key)
